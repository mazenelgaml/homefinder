...
import 'package:homefinder1/Screens/edit_listing_third_detail/edit_listing_third_detail.dart';
import 'package:homefinder1/models/second_edit_model.dart';
import '../../../services/residences_services.dart';

class EditListingSecondDetailController extends GetxController{
  final String residanceId;
  EditListingSecondDetailController(this.residanceId);
  ...
  Future<void> secondEdit(
      BuildContext context,
      ) async {
    try {
      SecondEditModel? data = await ResidenceServices.secondEdit(
          roofStyleSelected,
      ...
      if (data?.status == "success") {
        Get.to(() =>EditListingThirdDetailsScreen(residanceId: residanceId,));
      }
    } catch (e) {
