...
FirstEditModel welcomeFromJson(String str) => FirstEditModel.fromJson(json.decode(str));

String welcomeToJson(FirstEditModel data) => json.encode(data.toJson());

class FirstEditModel {
  String? status;
  Residence? residence;
  ...
  factory FirstEditModel.fromJson(Map<String, dynamic> json) => FirstEditModel(
    status: json["status"],
