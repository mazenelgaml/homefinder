...
//
//     final fourthCompleteModel = fourthCompleteModelFromJson(jsonString);

import 'dart:convert';

FourthCompleteModel fourthCompleteModelFromJson(String str) => FourthCompleteModel.fromJson(json.decode(str));

String fourthCompleteModelToJson(FourthCompleteModel data) => json.encode(data.toJson());
