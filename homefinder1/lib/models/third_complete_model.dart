...
ThirdCompleteModel thirdCompleteModelFromJson(String str) => ThirdCompleteModel.fromJson(json.decode(str));

String thirdCompleteModelToJson(ThirdCompleteModel data) => json.encode(data.toJson());
